<?php
	...
	function uf_print_encabezado_pagina1($as_titulo,$as_desnom,$as_periodo,&$io_pdf)
	{
		...
		$tm=306-($li_tm/2);
		$io_pdf->addText($tm,705,9,"Recibo ".$as_desnom); // Agregar el t�tulo
		$io_pdf->restoreState();
		$io_pdf->closeObject();
	...
	function uf_print_encabezado_pagina2($as_titulo,$as_desnom,$as_periodo,&$io_pdf)
	{
		...
		$li_tm=$io_pdf->getTextWidth(9,$as_periodo);
		$tm=306-($li_tm/2);
		$io_pdf->addText($tm,330,9,$as_periodo); // Agregar el t�tulo
		$li_tm=$io_pdf->getTextWidth(9,"Recibo ".$as_desnom);
		$tm=306-($li_tm/2);
		$io_pdf->addText($tm,315,9,"Recibo ".$as_desnom); // Agregar el t�tulo
		$io_pdf->restoreState();
		$io_pdf->closeObject();
		$io_pdf->addObject($io_encabezado,'all');
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_cabecera1($as_codper,$as_cedper,$as_nomper,$as_descar,&$io_cabecera,$ad_fecingper,$as_desuniadm,$ai_sueper,$as_codcueban,&$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$la_data[1]=array('nombre'=>'                                                             Apellidos y Nombres', 
						  'cedula'=>'C�dula','fechaingreso'=>'Fecha Ingreso','sueldo'=>'Sueldo             ');
		$la_data[2]=array('nombre'=>$as_nomper,'cedula'=>$as_cedper,'fechaingreso'=>$ad_fecingper,'sueldo'=>$ai_sueper);
		$la_columna=array('nombre'=>'Apellidos y Nombres', 'cedula'=>'C�dula','fechaingreso'=>'Fecha Ingreso','sueldo'=>'Sueldo');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'rowGap' => 0.5 ,
						 'cols'=>array('nombre'=>array('justification'=>'left','width'=>310), // Justificaci�n y ancho de la columna
						 			   'cedula'=>array('justification'=>'center','width'=>80), // Justificaci�n y ancho de la columna
						 			   'fechaingreso'=>array('justification'=>'center','width'=>80), // Justificaci�n y ancho de la columna
						 			   'sueldo'=>array('justification'=>'right','width'=>80))); // Justificaci�n y ancho de la columna
		...
		unset($la_columna);
		unset($la_config);
		$la_data=array(array('denomasig'=>'<b>CONCEPTOS</b>', 'valorasig'=>'<b>ASIGNACI�N</b>', 'denomdedu'=>'<b>CONCEPTOS</b>','valordedu'=>'<b>DEDUCCI�N</b>'));
		...
		$io_pdf->addText(25,620,'05','5454544545455454__dsfffffffffffffffffffffffsdfsdf___');
		$io_pdf->restoreState();
		$io_pdf->closeObject();
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_cabecera2($as_codper,$as_cedper,$as_nomper,$as_descar,&$io_cabecera,$ad_fecingper,$as_desuniadm,$ai_sueper,$as_codcueban,&$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_pie_cabecera1($ai_toting,$ai_totded,$ai_totnet,$as_codcueban,$as_pago,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('forma'=>array('justification'=>'left','width'=>155),
						 			   'cuenta'=>array('justification'=>'left','width'=>195), // Justificaci�n y ancho de la columna
						 			   'neto'=>array('justification'=>'right','width'=>150))); // Justificaci�n y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
	...
	else // Imprimimos el reporte
	{
		...
		$li_totrow=$io_report->rs_data->RecordCount('codper');
		...
		while((!$io_report->rs_data->EOF)&&($lb_valido))
		{
			...
			if($li_reg==1)
			{
				uf_print_cabecera1($ls_codper,$ls_cedper,$ls_nomper,$ls_descar,&$io_cabecera,$ld_fecingper,$ls_desuniadm,$li_sueper,$ls_codcueban,&$io_pdf); // Imprimimos la cabecera del registro
			}
			else
			{
				uf_print_cabecera2($ls_codper,$ls_cedper,$ls_nomper,$ls_descar,&$io_cabecera,$ld_fecingper,$ls_desuniadm,$li_sueper,$ls_codcueban,&$io_pdf); // Imprimimos la cabecera del registro
			}
			$ls_codperi="";
			if($ls_consolidar=="0")
			{
