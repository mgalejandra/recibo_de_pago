 ...
 */
 ...
 if ($_pagi_actual != 1){
	...
	$_pagi_navegacion_temporal[] = "<a href='#' onclick=\"xajax_selectAllCorrespondenciaConsulta(".$_pagi_url.");\">$_pagi_nav_primera</a>";

	// Si no estamos en la pgina 1. Ponemos el enlace "anterior"
	$_pagi_url = $_pagi_actual - 1; //ser el nmero de pgina al que enlazamos
	$_pagi_navegacion_temporal[] = "<a href='#' onclick=\"xajax_selectAllCorrespondenciaConsulta(".$_pagi_url.");\">$_pagi_nav_anterior</a>";
 }
 ...
 for ($_pagi_i = $_pagi_nav_desde; $_pagi_i<=$_pagi_nav_hasta; $_pagi_i++){//Desde pgina 1 hasta ltima pgina ($_pagi_totalPags)
	if ($_pagi_i == $_pagi_actual) {
	   ...
	   $_pagi_navegacion_temporal[] = "<a  href='#' onclick=\"xajax_selectAllCorrespondenciaConsulta(".$_pagi_i.");\">".$_pagi_i."</a>";
 ...
 if ($_pagi_actual < $_pagi_totalPags){
	...
	$_pagi_url = $_pagi_actual + 1; //ser el nmero de pgina al que enlazamos
	$_pagi_navegacion_temporal[] = "<a  href='#' onclick=\"xajax_selectAllCorrespondenciaConsulta(".$_pagi_url.");\">$_pagi_nav_siguiente</a>";

	// Si no estamos en la ltima pgina. Ponemos el enlace "ltima"
	$_pagi_url = $_pagi_totalPags; //ser el nmero de pgina al que enlazamos
	$_pagi_navegacion_temporal[] = "<a  href='#' onclick=\"xajax_selectAllCorrespondenciaConsulta(".$_pagi_url.");\">$_pagi_nav_ultima</a>";
 }
