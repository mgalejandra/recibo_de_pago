...
class sigesp_snorh_class_report
{
	...
	function uf_listadopersonalrelacion_rac($as_codnom,$as_codperdes,$as_codperhas,$as_orden)
	{
		...
		// Fecha Creaci�n: 19/12/2011 								Fecha �ltima Modificaci�n :  
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		$ls_criterio="";
		$ls_orden="";
		...
		if($this->rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Report M�TODO->uf_listadopersonalrelacion_rac ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
  ...
  /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		if($ls_valor=='1')
		{
	 	...
	 	$ls_sql="SELECT sno_hpersonalnomina.codper, substr(cast(sno_hperiodo.fecdesper as char(10)),1,4) AS anocur, substr(cast(sno_hperiodo.fecdesper as char(10)),6,2) as mes,(30) as dias, ".
                "       MAX(sno_hpersonalnomina.sueper) as sueper, SUM(sno_hpersonalnomina.sueintper) as sueintper, max(sno_personal.nomper) as nomper, ".
			    ...
			    "  JOIN sno_hperiodo ".
				"    ON substr(cast(sno_hperiodo.fecdesper as char(10)),1,4)>='".$ano2."' ".
				"   AND substr(cast(sno_hperiodo.fecdesper as char(10)),1,4)<='".$ano1."' ".
				"   AND sno_hpersonalnomina.codemp=sno_hperiodo.codemp ".
                "   AND sno_hpersonalnomina.codnom=sno_hperiodo.codnom			".
                "   AND sno_hpersonalnomina.anocur=substr(cast(sno_hperiodo.fecdesper as char(10)),1,4)			".
                "   AND sno_hpersonalnomina.codperi=sno_hperiodo.codperi         ".
			    "  JOIN sno_hnomina ".
			    ...
			    " WHERE sno_hpersonalnomina.codemp='".$this->ls_codemp."'".
                "   AND sno_hpersonalnomina.codper='".$as_codper."' ".
			    " GROUP BY sno_hpersonalnomina.codper, substr(cast(sno_hperiodo.fecdesper as char(10)),1,4), substr(cast(sno_hperiodo.fecdesper as char(10)),6,2)".
			    " ORDER BY substr(cast(sno_hperiodo.fecdesper as char(10)),6,2), substr(cast(sno_hperiodo.fecdesper as char(10)),1,4)";
		$rs_data=$this->io_sql->select($ls_sql);		
		if($rs_data===false)
		{
